...
function proccessMessage(input) {
    ...
    if (match) {
      ...
      output="If you have an user related problem, you can contact the administration services, by calling xxxxxxxxx"
    }
    else if (text.match(/admin/gi)){
      output="If you can't get into the admin account, you can contact the administration services, by calling xxxxxxxxx"
    }
    else {
